...
<Hero title="Empathise & Define" subtitle="Observe, ask, listen, define, and focus" />


<main class="content section" id="empathise-define">

  <h2>
    Empathise & Define <em class="has-text-info">- Te Pō</em>
  </h2>
